...
<head>
    ...
    <title>Configuracion Razas</title>
    ...
    <style>
        ...
        #razasTable th, #razasTable td {
            padding: 10px;
            text-align: center;
            border: 1px solid #ddd;
            border-radius: 10px;
        }
        #razasTable tbody tr:nth-child(even) {
            background-color:rgb(234, 250, 219);
            border-radius: 10px;
        }
        #razasTable tbody tr:hover {
...
<div class="container">
    <h3 class="section-title text-center bg-success text-white">Razas</h3>
</div>
