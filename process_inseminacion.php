...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['action'])) {
    ...
    $query = "INSERT INTO vh_inseminacion (vh_inseminacion_tagid, vh_inseminacion_numero, vh_inseminacion_costo, vh_inseminacion_fecha) 
              VALUES ('$tagid', '$numero', '$costo', '$fecha')";
