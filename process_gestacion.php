...
function handleDelete($conn) {
    ...
    $query = "DELETE FROM vh_gestacion WHERE id = '$id'";
...
function handleUpdate($conn) {
    try {
        ...
        $query = "UPDATE vh_gestacion SET 
                  vh_gestacion_tagid = '$tagid',
                  vh_gestacion_producto = '$producto',
                  vh_gestacion_dosis = '$dosis',
                  vh_gestacion_costo = '$costo',                  
                  vh_gestacion_fecha = '$fecha'
                  WHERE id = '$id'";
...
function handleInsert($conn) {
    try {
        ...
        $query = "INSERT INTO vh_gestacion 
                  (vh_gestacion_tagid, vh_gestacion_producto, vh_gestacion_dosis, vh_gestacion_costo, 
                    vh_gestacion_fecha) 
                  VALUES 
