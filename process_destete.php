...
function handleUpdate($conn) {
    try {
        ...
        $query = "UPDATE vh_destete SET 
                  vh_destete_tagid = '$tagid',
                  vh_destete_peso = '$peso',
                  vh_destete_fecha = '$fecha'
                  WHERE id = '$id'";
...
function handleInsert($conn) {
    try {
        ...
        $query = "INSERT INTO vh_destete 
                  (vh_destete_tagid, vh_destete_peso, vh_destete_fecha) 
                  VALUES 
                  ('$tagid', '$peso', '$fecha')";
