...
function handleUpdate($conn) {
    try {
        ...
        $query = "UPDATE vh_aftosa SET 
                  vh_aftosa_tagid = '$tagid',
                  vh_aftosa_dosis = '$dosis',
                  vh_aftosa_costo = '$costo',
                  vh_aftosa_producto = '$producto',
                  vh_aftosa_fecha = '$fecha'
                  WHERE id = '$id'";
...
function handleInsert($conn) {
    try {
        ...
        $query = "INSERT INTO vh_aftosa 
                  (vh_aftosa_tagid, vh_aftosa_dosis, vh_aftosa_costo, 
                   vh_aftosa_producto, vh_aftosa_fecha) 
                  VALUES 
