      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="logo-img-center pt-3 d-flex justify-content-center">
            <a href="https://ganagram.com/vacuno/inventario_vacuno.php">
    ...
    <div class="col-6 col-md-3">
      <div class="card">
        <div class="card-body">
          ...
          <div class="logo-img-center pt-3 d-flex justify-content-center">
            <a href="https://ganagram.com/bufalino/inventario_bufalino.php">
    ...
    <div class="col-6 col-md-3">
      <div class="card">
        <div class="card-body">
          ...
          <div class="logo-img-center pt-3 d-flex justify-content-center">
            <a href="https://ganagram.com/porcino/inventario_porcino.php">
    ...
    <div class="col-6 col-md-3">
      <div class="card">
        <div class="card-body">
          ...
          <div class="logo-img-center pt-3 d-flex justify-content-center">
            <a href="https://ganagram.com/aviar/inventario_aviar.php">
