...
function handleDelete($conn) {
    ...
    $query = "DELETE FROM vh_mastitis WHERE id = '$id'";
...
function handleUpdate($conn) {
    try {
        ...
        $query = "UPDATE vh_mastitis SET 
                  vh_mastitis_tagid = '$tagid',
                  vh_mastitis_producto = '$producto',
                  vh_mastitis_dosis = '$dosis',
                  vh_mastitis_costo = '$costo',                  
                  vh_mastitis_fecha = '$fecha'
                  WHERE id = '$id'";
...
function handleInsert($conn) {
    try {
        ...
        $query = "INSERT INTO vh_mastitis 
                  (vh_mastitis_tagid, vh_mastitis_producto, vh_mastitis_dosis, vh_mastitis_costo, 
                    vh_mastitis_fecha) 
                  VALUES 
