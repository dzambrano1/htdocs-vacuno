                ...
                <div class="card-body">                
                    ...
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="aftosa-producto" name="vh_aftosa_producto" class="form-control" required>
                          ...
                          <?php
                          // Fetch unique productos from vh_aftosa table
                          $conn_aftosa_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="aftosa-dosis" name="vh_aftosa_dosis" class="form-control" required>
                          <option value="">Select Dosis</option>
                          <?php
                          // Fetch unique dosis from vh_aftosa table
                          $conn_aftosa_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="aftosa-costo" name="vh_aftosa_costo" class="form-control" required>
                          ...
                          $conn_aftosa_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <div class="card-body">                
                    ...
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="ibr-producto" name="vh_ibr_producto" class="form-control" required>
                          ...
                          $conn_ibr_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          ...
                          $conn_ibr_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="ibr-costo" name="vh_ibr_costo" class="form-control" required>
                          ...
                          $conn_ibr_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <form action="vacuno_update_cbr.php" method="POST">
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="cbr-producto" name="vh_cbr_producto" class="form-control" required>
                          <option value="">Select Producto</option>
                          <?php
                          $conn_cbr_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_cbr_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="cbr-costo" name="vh_cbr_costo" class="form-control" required>
                          <option value="">Select Costo</option>
                          <?php
                          $conn_cbr_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <form action="vacuno_update_brucelosis.php" method="POST">
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="brucelosis-producto" name="vh_brucelosis_producto" class="form-control" required>
                          <option value="">Select Producto</option>
                          <?php
                          $conn_brucelosis_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_brucelosis_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="brucelosis-costo" name="vh_brucelosis_costo" class="form-control" required>
                          <option value="">Select Costo</option>
                          <?php
                          $conn_brucelosis_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <form action="vacuno_update_carbunco.php" method="POST">
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="carbunco-producto" name="vh_carbunco_producto" class="form-control" required>
                          <option value="">Select Producto</option>
                          <?php
                          $conn_carbunco_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_carbunco_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="carbunco-costo" name="vh_carbunco_costo" class="form-control" required>
                          <option value="">Select Costo</option>
                          <?php
                          $conn_carbunco_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <form action="vacuno_update_garrapatas.php" method="POST">
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="garrapatas-producto" name="vh_garrapatas_producto" class="form-control" required>
                          <option value="">Select Producto</option>
                          <?php
                          $conn_garrapatas_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_garrapatas_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_garrapatas_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <form action="vacuno_update_mastitis.php" method="POST">
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="mastitis-producto" name="vh_mastitis_producto" class="form-control" required>
                          <option value="">Select Producto</option>
                          <?php
                          $conn_mastitis_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_mastitis_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="mastitis-costo" name="vh_mastitis_costo" class="form-control" required>
                          <option value="">Select Costo</option>
                          <?php
                          $conn_mastitis_costo = new mysqli('localhost', 'root', '', 'ganagram');
                ...
                <form action="vacuno_update_lombrices.php" method="POST">
                    <input type="hidden" name="tagid" value="<?php echo htmlspecialchars($tagid); ?>" /> 
                      ...
                      <select id="lombrices-producto" name="vh_lombrices_producto" class="form-control" required>
                          <option value="">Select Producto</option>
                          <?php
                          $conn_lombrices_producto = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <?php
                          $conn_lombrices_dosis = new mysqli('localhost', 'root', '', 'ganagram');
                      ...
                      <select id="lombrices-costo" name="vh_lombrices_costo" class="form-control" required>
                          <option value="">Select Costo</option>
                          <?php
                          $conn_lombrices_costo = new mysqli('localhost', 'root', '', 'ganagram');
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="vacuno_update_concentrado.php" method="POST">
                  ...
                  <input type="text" id="concentrado-etapa" name="vh_concentrado_etapa" class="form-control" value="<?php echo isset($latestConcentradoEtapa) ? $latestConcentradoEtapa : ''; ?>" required />
                  <label for="concentrado-producto">Producto:</label>
                  <input type="text" id="concentrado-producto" name="vh_concentrado_producto" class="form-control" value="<?php echo isset($latestConcentrado) ? $latestConcentrado : ''; ?>" required />
                  ...
                  <input type="number" step="0.1" id="concentrado-costo" name="vh_concentrado_costo" class="form-control"  value="<?php echo isset($latestConcentradoCosto) ? $latestConcentradoCosto : ''; ?>" required />                            
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="vacuno_update_sal.php" method="POST">
              ...
              <input type="text" id="sal-etapa" name="vh_sal_etapa" class="form-control" value="<?php echo isset($latestSalEtapa) ? $latestSalEtapa : ''; ?>" required />
              <label for="sal-producto">Producto:</label>
              <input type="text" id="sal-producto" name="vh_sal_producto" class="form-control" value="<?php echo isset($latestSalProducto) ? $latestSalProducto : ''; ?>" required />
              ...
              <input type="number" step="0.1" id="sal-costo" name="vh_sal_costo" class="form-control" value="<?php echo isset($latestSalCosto) ? $latestSalCosto : ''; ?>" required />
      ...
      <div class="card">
        ...
        <div class="card-body">
            <form action="vacuno_update_melaza.php" method="POST">
              ...
              <input type="text" id="melaza-etapa" name="vh_melaza_etapa" class="form-control" value="<?php echo isset($latestMelazaEtapa) ? $latestMelazaEtapa : ''; ?>" required />
              <label for="melaza-producto">Producto:</label>
              <input type="text" id="melaza-producto" name="vh_melaza_producto" class="form-control" value="<?php echo isset($latestMelazaProducto) ? $latestMelazaProducto : ''; ?>" required />
              ...
              <input type="number" step="0.1" id="melaza-costo" name="vh_melaza_costo" class="form-control" value="<?php echo isset($latestMelazaCosto) ? $latestMelazaCosto : ''; ?>" required />
